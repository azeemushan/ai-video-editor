      ...
      {currentSubscription ? (
        <div className="bg-white shadow-md rounded-lg p-6 mb-6">
          <div className="mb-4 flex items-center justify-center text-center">
            ...
            <p className='text-sm pt-2 pl-2'> ({currentSubscription?.subscriptionPackage?.sub_dur_type})</p>
          </div>
          {renderUsage()}
        ...
        <div className="bg-white shadow-md rounded-lg p-6 mb-6 text-center">
          <p className="text-lg font-bold text-gray-900 mb-4">{t('no-subscription')}</p>
          <Link href="/pricing">
